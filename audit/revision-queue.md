...
## Счётчик
- Очередь чтения: 10 · прочитано 3 · исправлено 1
...
- ☑ clt · staccato 69% — намеренная ритмика, ОК; разряжен финал вступления + якорь fat tails · статус: закоммичено
- ☐ markov-deep · staccato 10 (рекорд) — проверить, проза или каталог
- ☐ math-music · staccato 5/44%
- ☐ five-letters · staccato 5/40%
...
monte-carlo (MCMC + Паста), games-that-train-machines (актуальность + EN),
