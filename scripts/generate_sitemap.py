...
EXCLUDED = {
    ...
    # Подтверждение владения ресурсом в Google Search Console.
    # Не страница и не должен индексироваться. Исключение обязательно:
    # find_pages() обходит все *.html на диске, поэтому без этой строки
    # файл попадает в карту сам собой. Удалять файл нельзя — см. README.
    "google9b84a06f40ea405c.html",
}
